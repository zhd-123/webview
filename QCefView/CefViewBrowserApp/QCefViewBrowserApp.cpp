...
QCefViewBrowserApp::OnBeforeCommandLineProcessing(const CefString& process_type, CefRefPtr<CefCommandLine> command_line)
{
  ...
  command_line->AppendSwitchWithValue("proxy-auto-detect", "0");
  command_line->AppendSwitchWithValue("enable-begin-frame-scheduling", "1");
  command_line->AppendSwitchWithValue("disable-gpu-vsync", "0");
//  command_line->AppendSwitchWithValue("v8-cache-options", "0");
//  command_line->AppendSwitchWithValue("disable-application-cache", "1");
}
